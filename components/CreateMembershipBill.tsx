...
export default function CreateMembershipBill({ onClose }: { onClose: () => void }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm overflow-y-auto">
            <div className="bg-theme-bg-card w-full max-w-3xl rounded-xl shadow-2xl border border-theme-border flex flex-col max-h-[90vh]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <input disabled className="w-full px-3 py-2 border border-theme-border bg-theme-bg-main rounded-md shadow-sm sm:text-sm text-theme-text-muted cursor-not-allowed" defaultValue="INV-2024-1065" type="text" />
                                </div>

                                <div>
                                    <label className="block text-sm font-semibold mb-1.5 text-theme-text-main">Membership Plan<span className="text-red-500">*</span></label>
                                    <div className="relative">
                                        <select className="w-full px-3 py-2 border border-theme-border bg-theme-bg-main rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-theme-primary-main focus:border-theme-primary-main sm:text-sm appearance-none cursor-pointer text-theme-text-main">
                                            <option value="annual_pro">Annual Pro Elite</option>
                                ...
                                <div>
                                    <label className="block text-sm font-semibold mb-1.5 text-theme-text-main">Start Date<span className="text-red-500">*</span></label>
                                    <input className="w-full px-3 py-2 border border-theme-border bg-theme-bg-main rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-theme-primary-main focus:border-theme-primary-main sm:text-sm text-theme-text-main" type="date" defaultValue="2024-10-31" />
                                </div>

                                <div>
                                    <label className="block text-sm font-semibold mb-1.5 text-theme-text-main">Remarks</label>
                                    <textarea className="w-full px-3 py-2 border border-theme-border bg-theme-bg-main rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-theme-primary-main focus:border-theme-primary-main sm:text-sm text-theme-text-main resize-none h-[88px]" placeholder="Add any special notes..." />
                                </div>
                            </div>
                ...
                <div className="p-6 border-t border-theme-border bg-theme-bg-main flex justify-end gap-3 rounded-b-xl">
                    ...
                    <button onClick={onClose} className="px-5 py-2 bg-theme-primary-main text-white rounded-lg text-sm font-bold hover:bg-theme-primary-hover transition-colors shadow-sm flex items-center gap-2">
